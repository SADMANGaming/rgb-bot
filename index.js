...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        Bot Prefix: \`${prefix}\`
        Invite Link: [Click Here](https://discord.com/api/oauth2/authorize?client_id=911575852007956500&permissions=8&scope=bot%20applications.commands)

        :question: Still need help? [Click Here](https://discord.com/invite/5eQTvz3PK5) to join server
        `)
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Coder: SADMAN                          |
 |-----------------------------------------|
 |• Server:discord.com/invite/5eQTvz3PK5   |
 |-----------------------------------------|
 |• Name : Random Bot                      |
 |-----------------------------------------|
...
client.on("ready", async () => {
  ...
  client.user
    .setActivity(`$help | Sadman Gaming`, { type: "LISTENING" })
